...
export function langColor(lang: string): string {
  switch (lang) {
    ...
    case 'toml': return sol.base1;
    case 'sql': return sol.blue;
    case 'c': return sol.base0;
    case 'cpp': return sol.base0;
    case 'h': return sol.base00;
    case 'cs': return sol.violet;
    case 'kt': return sol.violet;
    case 'swift': return sol.orange;
    case 'tf': return sol.violet;
    case 'proto': return sol.cyan;
    case 'dockerfile': return sol.blue;
    case 'makefile': return sol.yellow;
    case 'elixir': return sol.violet;
    case 'haskell': return sol.violet;
    case 'lua': return sol.blue;
    case 'php': return sol.violet;
    case 'dart': return sol.cyan;
    case 'zig': return sol.yellow;
